...
export default function Credentials(): React.JSX.Element {
  ...
  const btnStyle = "inline-block px-3 py-2 rounded-xl border border-zinc-800 hover:bg-white/10 active:bg-blue-400 text-sm transition duration-300 text-center ml-15 mt-2";
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className={cardStyle}>
            ...
            <p className="text-xs text-zinc-500 mt-4 mb-6">
              • Volatility Forecasting • Machine Learning: Random Forest • Python Analytics • Risk Modeling • NSE|BSE Data <a href="/NCMPCS.PDF" className={btnStyle}>
                Certificate
              </a>
            </p>
          </div>
          ...
          {/* Blog */}
          <div className={cardStyle}>
            <h3 className="text-2xl font-bold mb-4 group-hover:text-blue-400 transition duration-300">Blogs</h3>
            <p className="text-zinc-400 leading-relaxed">
            ...
            <p className="text-xs text-zinc-500 mt-4 mb-6">
              <GradientText
                                ...
                                animationSpeed={1}
                                showBorder={true}
                                className="py-3 px-2 mt-3 inline"
                              >Active 
                              </GradientText> • Xela_Arcade Architecture Blueprint<a href="https://docs.google.com/document/d/19uTBz7EuTVufrOsQsNTRrwAKSsSPFJLwatDf_PN8xOI/edit?usp=sharing" className={btnStyle}>Explore
              </a>
            </p>
          </div>
